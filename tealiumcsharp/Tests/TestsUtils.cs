...
namespace Tests
{
    ...
    public class TestsUtils
    {
        ...
        [Test()]
        public void TestsDictionaryToJsonJustStrings()
        {
            Dictionary<string, object> data = new Dictionary<string, object>
            {
                { "string_value_1", "string1" },
                { "string_value_2", "string2" }
            };

            string jsonString = Utils.DictionaryToJsonString(data);
            Assert.AreEqual(jsonString, "{\"string_value_1\":\"string1\",\"string_value_2\":\"string2\"}");
        }

        [Test()]
        public void TestsDictionaryToJsonWithArrays()
        {
            Dictionary<string, object> data = new Dictionary<string, object>
            {
                { "array_value_1", new string[] { "1", "2", "3" } },
                { "array_value_2", new string[] { "4", "5", "6" } }
            };

            string jsonString = Utils.DictionaryToJsonString(data);
            Assert.AreEqual(jsonString, "{\"array_value_1\":[\"1\",\"2\",\"3\"],\"array_value_2\":[\"4\",\"5\",\"6\"]}");
        }

        [Test()]
        public void TestsDictionaryToJsonWithDictionaries()
        {
            ...
            string jsonString = Utils.DictionaryToJsonString(data);
            Assert.AreEqual(jsonString, "{\"string_value_1\":\"string1\",\"array_value_1\":[\"1\",\"2\",\"3\"],\"dictionary_1\":{\"string_value_1\":\"string1\",\"array_value_1\":[\"1\",\"2\",\"3\"]}}");
        }
    }
